 ...
 */
public class CustomLoginButton extends FacebookButtonBase {
...
*/
    ...
    private void setButtonText() {
        ...
        if (!isInEditMode() && AccessToken.getCurrentAccessToken() != null) {
            ...
            this.setBackgroundDrawable(estados_boton2);
        } else {
            if (loginText != null) {
                setText(loginText);
            } else {
        ...
        public void onClick(View v) {
            ...
            if (accessToken != null) {
                ...
                if (confirmLogout) {
                    ...
                    String logout = "Cerro sesion";/*getResources().getString(
                            R.string.com_facebook_loginview_log_out_action);*/
                    String cancel = "Cancelo";/*getResources().getString(
                ...
                if (LoginAuthorizationType.PUBLISH.equals(properties.authorizationType)) {
                    if (CustomLoginButton.this.getFragment() != null) {
                        loginManager.logInWithPublishPermissions(
                                CustomLoginButton.this.getFragment(),
                                properties.permissions);
                    } else if (CustomLoginButton.this.getNativeFragment() != null) {
                        loginManager.logInWithPublishPermissions(
                                CustomLoginButton.this.getNativeFragment(),
                                properties.permissions);
                    } else {
                        loginManager.logInWithPublishPermissions(
                                CustomLoginButton.this.getActivity(),
                                properties.permissions);
                    }
                } else {
                    if (CustomLoginButton.this.getFragment() != null) {
